_base_ = 'promptdet_r50_fpn_sample1e-3_mstrain_6x_lvis_v1.py'
...
data = dict(
    train_uncurated=dict(
        type='TwoScaleDataset',
        min_scales=(100, 432, 1200),
        max_scale=2048,
        ann_file='data/laion_lvis/laion_train.json',
        img_prefix='data/laion_lvis/images',
        classes=classes,
        pipeline=[
...
runner = dict(type='EpochPromptDetRunner', max_epochs=72)
evaluation = dict(metric=['bbox', 'segm'], interval=12)
resume_from = 'work_dirs/promptdet_r50_fpn_sample1e-3_mstrain_6x_lvis_v1/epoch_60.pth'
